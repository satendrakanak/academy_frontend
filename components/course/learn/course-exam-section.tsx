...
export function CourseExamSection({ course }: CourseExamSectionProps) {
  ...
  useEffect(() => {
    if (timeRemaining === 0 && payload?.canAttempt && hasStarted && !isSubmitting) {
      void handleSubmit(true);
    }
  }, [handleSubmit, hasStarted, isSubmitting, payload?.canAttempt, timeRemaining]);
            ...
            <div className="grid gap-5 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)]">
              <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5">
                ...
                <div className="mt-4 space-y-2 text-sm text-slate-600">
                  ...
                  <p>4. Your certificate unlocks only after a passing result.</p>
                </div>
              </div>
