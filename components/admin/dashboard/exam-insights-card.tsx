...
export function ExamInsightsCard({ data }: { data: AdminDashboardData }) {
  return (
    <Card className="overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-[0_24px_60px_-42px_rgba(15,23,42,0.28)]">
      <CardHeader className="border-b border-slate-100 bg-[linear-gradient(135deg,var(--brand-50),#ffffff)]">
