...
export function PermissionDialog({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} direction="right">
      <DrawerContent className="w-full border-l border-[var(--brand-100)] bg-white sm:max-w-[560px]">
        ...
        <ScrollArea className="h-[calc(100vh-146px)]">
          <div className="space-y-5 px-6 py-5">
              ...
              <div className="flex flex-wrap gap-2">
                {permissionActionPresets.map((action) => (
                  <button
                    ...
                    className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-medium text-slate-600 transition hover:border-[var(--brand-200)] hover:bg-[var(--brand-50)]"
                  >
                    {action}
                  </button>
                ))}
            ...
            <div className="rounded-2xl border border-[var(--brand-100)] bg-[var(--brand-50)]/50 px-4 py-3">
