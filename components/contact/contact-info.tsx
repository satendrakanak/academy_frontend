...
export function ContactInfo() {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[32px] border border-[var(--brand-100)] bg-[linear-gradient(160deg,#ffffff_0%,#f9fbff_48%,#eef4ff_100%)] p-6 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.4)] md:p-8">
      ...
      <div className="rounded-[28px] border border-[var(--brand-100)] bg-white p-6 shadow-[0_18px_48px_-36px_rgba(15,23,42,0.35)]">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[var(--brand-200)] px-4 py-2 text-sm font-semibold text-[var(--brand-700)] transition hover:bg-[var(--brand-50)]"
          >
            View Testimonials
          </Link>
        </div>
...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-4 rounded-2xl border border-white/70 bg-white/90 p-4">
      <div className="flex size-11 items-center justify-center rounded-2xl bg-[var(--brand-50)] text-[var(--brand-700)]">
